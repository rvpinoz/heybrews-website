...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      if (isWebGL2) {
        gl.getExtension('EXT_color_buffer_float'); // critical for WebGL2 float FBOs
    ...
    class Material {
      ...
      constructor(vertexShader: any, fragmentShaderSource: string) {
        ...
        this.programs = []; this.activeProgram = null; this.uniforms = {} as any;
      }
    ...
    function initFramebuffers() {
      ...
      if (!rgba || !rg || !r) return; // bail if formats unsupported
  ...
  return (
    <div style={{
      ...
      // z-index 1: behind Navbar (z-100) and Preloader (z-99999), above page bg
      zIndex: 1,
      pointerEvents: 'none',
      // 100% not 100vw — avoids horizontal overflow from scrollbar width
